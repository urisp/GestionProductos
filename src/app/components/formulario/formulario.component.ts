          ...
          text: 'Corte de Acero', style: 'header',alignment: 'center'},
        {
          table: {
            body: [
              ...
              [{text: 'Kilogramos a cortar', style: 'tableHeader',alignment: 'center'},{text: this.valorKilogramos, style: 'tableHeader', alignment: 'center',colSpan: 2},{}],
              ...
              [{text: 'Largo de barra', style: 'tableHeader', alignment: 'center'}, {text: this.campos.longBarra, style: 'tableHeader', alignment: 'center'}, {text: '', style: 'tableHeader', alignment: 'center'}],
              [{text: 'Longitud de tocho', style: 'tableHeader', alignment: 'center'}, {text: this.campos.longTocho, style: 'tableHeader', alignment: 'center'}, {text: '', style: 'tableHeader', alignment: 'center'}],
              [{text: 'Peso de tocho', style: 'tableHeader', alignment: 'center'}, {text: this.campos.pesoTocho, style: 'tableHeader', alignment: 'center'}, {text: '', style: 'tableHeader', alignment: 'center'}],
